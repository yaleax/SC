...
async function SwitchRegion(play) {
	...
	const TW = $.read('BiliArea_TW') || 'TenCloud'; //Your Taiwan sub-policy name.
	const HK = $.read('BiliArea_HK') || 'TenCloud'; //Your HongKong sub-policy name.
	const DF = $.read('BiliArea_DF') || 'TenCloud'; //Sub-policy name used after region is blocked(e.g. url 404)
